...
{
 db.setItem("idioma","es-MX");
 w3.removeClass("#idingles","w3-disabled");
 w3.addClass("#idespanhol","w3-disabled");
 w3.removeClass("#idfrances","w3-disabled");
 w3.removeClass("#idportugues","w3-disabled");

}
function idiomaFrances()
{
 db.setItem("idioma","fr-FR");
 w3.removeClass("#idingles","w3-disabled");
 w3.removeClass("#idespanhol","w3-disabled");
 w3.addClass("#idfrances","w3-disabled");
 w3.removeClass("#idportugues","w3-disabled");
