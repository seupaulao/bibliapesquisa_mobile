...
selecionarTitulo=function(plano)
{
  ...
  switch(plano){
     ...
     case 4: setSiglaPlano('ev');  return nacionalidade ? "Evangelho" : "Gospel";   break;
     case 5: setSiglaPlano('vt');  return nacionalidade ? "Velho Testamento" : "Old Testament";   break;
     case 6: setSiglaPlano('nt');  return nacionalidade ? "Novo Testamento" : "New Testament";   break;
     case 7: setSiglaPlano('lis'); return nacionalidade ? "Livros da Sabedoria" : "Books of Wisdom";   break;
  }
}
...
setarSiglaPlano=function(plano)
{
   switch (plano)
   {
     ...
     case 3:  setSiglaPlano('pen'); break;
     case 4:  setSiglaPlano('ev');  break;
     case 5:  setSiglaPlano('vt');  break;
     case 6:  setSiglaPlano('nt');  break;
     case 7:  setSiglaPlano('lis'); break;
   }
}
...
carregarPlano = function(plano)
{
  ...
  switch (plano)
  {
    ...
    case 4: str = planoEvangelho(); break;
    case 5: str = planoVT(); break;
    case 6: str = planoNT(); break;
    case 7: str = planoLivrosSabedoria(); break;
  }
  return str;
}
...
planoLivrosSabedoria=function()
{
 ...
 return calculaPlanoBasico(soma+1, somac+soma, 3, v);
}

planoPenta = function()
{
  var gcap = carregarVetorCapitulos(getBlvOrWeb());
  return calculaPlanoBasico(1, 187, 3, gcap);
}

planoEvangelho = function()
{
  var gcap = carregarVetorCapitulos(getBlvOrWeb());
  return calculaPlanoBasico(somaTodosGCapVT(gcap)+1, 89+somaTodosGCapVT(gcap), 3, gcap);
}
